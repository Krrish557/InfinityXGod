...
from tgbot.database.sql import BASE, SESSION
...
WelcomeButtons.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
GoodbyeButtons.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
WelcomeMute.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
WelcomeMuteUsers.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
CleanServiceSetting.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
RaidMode.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
