...
CleanerBlueTextChatSettings.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
CleanerBlueTextChat.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
CleanerBlueTextGlobal.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
