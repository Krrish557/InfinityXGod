...
ReportingUserSettings.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
ReportingChatSettings.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
