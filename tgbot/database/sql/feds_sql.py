...
Federations.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
ChatF.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
BansF.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
FedsUserSettings.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
FedSubs.__table__.create(bind=SESSION.get_bind(), checkfirst=True)
