...
from tgbot.database.sql import SESSION, BASE
...
BASE.metadata.create_all(bind=SESSION.get_bind(), tables=[ChatAccessConnectionSettings.__table__, Connection.__table__, ConnectionHistory.__table__])
