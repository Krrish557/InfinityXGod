...
from tgbot.vars import SUPPORT_CHAT
...
def sudolist(update: Update, context: CallbackContext):
    ...
    true_sudo = list(set(SUDOS) - set(DEV_USERS))
...
*List all special users:*
 ❍ `/SUDOS`*:* Lists all Dragon disasters
 ❍ `/HELPERS`*:* Lists all Demon disasters
...
SUPPORTLIST_HANDLER = CommandHandler(["servantlist", "servants", "HELPERS", "demonlist"], supportlist, run_async=True)
SUDOLIST_HANDLER = CommandHandler(["friendlist", "friends", "sudos", "SUDOS", "sudolist", "dragonlist"], sudolist, run_async=True)
