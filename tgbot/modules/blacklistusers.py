...
import html
import tgbot.database.sql.blacklistusers_sql as sql
from tgbot import (
    DEV_USERS,
    OWNER_ID,
    SUDOS,
...
BLACKLISTWHITELIST = [OWNER_ID] + DEV_USERS + SUDOS  + HELPERS
...
def bl_user(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("I can not blacklist myself :/")
        return ""
...
def unbl_user(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("Can not BlackList myself :/")
        return ""
