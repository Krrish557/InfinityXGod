...
from tgbot.vars import LOG_CHANNEL
from tgbot.modules.helper_funcs.chat_status import user_admin
from tgbot.database.sql import log_channel_sql as sql
...
def unsetlog(update: Update, context: CallbackContext):
    ...
    if log_channel:
        ...
        message.reply_text("Log channel has been un-linked.")

    else:
        message.reply_text("No log channel is assigned!")
