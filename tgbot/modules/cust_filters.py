...
from tgbot import dispatcher, LOGGER, SUDOS
...
from tgbot.database.sql import cust_filters_sql as sql
...
def rmall_filters(update, context):
    ...
    if member.status != "creator" and user.id not in SUDOS:
        update.effective_message.reply_text(
            "Permission of clearing all Filters at once is only available for chat owner.."
        )
    else:
