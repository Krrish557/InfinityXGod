...
from tgbot import SUDOS as SUDO_USERS
from tgbot import pbot, dispatcher
from tgbot.database.sql import forceSubscribe_sql as sql
    ...
    if user.status == "creator" or user.user.id in SUDO_USERS:
        ...
        if len(message.command) > 1:
            ...
            if input_str.lower() in ("off", "no", "disable"):
                ...
                message.reply_text("❌ **Force Subscribe is now Disabled.**")
